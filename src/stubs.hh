...
extern void SendFinishRequest(TConnection *Connection, const char *Name);
extern void SendFullScreen(TConnection *Connection);
extern void SendFloors(TConnection *Connection, bool Up);
extern void SendInitGame(TConnection *Connection, uint32 CharacterID);
extern void SendRights(TConnection *Connection);
extern void SendOutfit(TConnection *Connection);
